    ...
    return (
      <View>
        ...
        <Text>                                    SURFACE</Text>
            <Text></Text>
            <Text></Text>
          <Image source={       require('../Images/4A.png')}   style={{width: 193, height: 110}} />
                            <Text>Open Gauze packet and place </Text>
                              <Text> it nearby for future uses</Text>
                              <Text></Text>
                                <Image source={       require('../Images/4B.jpg')}   style={{width: 193, height: 110}} />
                                <Text>Make sure to oreint the test so the lip </Text>
                                <Text>          faces towards you</Text>
      <Button onPress= {() => this.props.navigation.navigate ('GuestInstructions4')}
        title="Next"/>
</View>
          );
        }
